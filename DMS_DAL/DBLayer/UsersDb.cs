...
namespace DMS_DAL.DBLayer
{
    public class UsersDb
    {
        ...
        {
            var reas = _context.tblDoctors.Where(x => x.D_ID == modelId).FirstOrDefault();
            reas.tblAddress = _context.tblAddresses.Find(reas.D_AddressID);
            reas.tblAddress.tblCity = _context.tblCities.Find(reas.tblAddress.AddressCity);
            reas.tblAddress.tblState = _context.tblStates.Find(reas.tblAddress.AddressState);
            reas.tblAddress.tblZone = _context.tblZones.Find(reas.tblAddress.AddressZone);
            return reas;
        ...
        public UserViewDetail GetUserDetailByEmail(string emailtext)
        {
            ...
            {
                ID = s.D_ID,
                Name = s.D_FirstName +" "+ s.D_LastName,
                Email = s.D_Email,
            ...
            {
                ID = s.P_ID,
                Name = s.P_FirstName +" "+ s.P_LastName,
                Email = s.P_Email,
