...
namespace DMS_DAL.DBLayer
{
    public class DoctorServicesDb
    {
        ...
        public IEnumerable<string> GetAllDoctorServicesByID(int modelId)
        {
            return _context.tblDoctorServices.Where(x => x.DS_DoctorID == modelId).Select(x => x.tblService.S_Name).ToList();
        }
