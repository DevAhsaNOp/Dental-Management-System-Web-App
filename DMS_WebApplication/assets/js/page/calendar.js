...
var calendar = $('#myEvent').fullCalendar({
    ...
    events: [{
        title: "Akbar Ali",
        start: new Date(year, month, day, 10, 00),
        end: new Date(year, month, day, 10, 30),
        backgroundColor: "#00bcd4"
    }, {
        title: "Azhar Aleem",
        start: new Date(year, month, day, 16, 00),
        end: new Date(year, month, day, 16, 30),
        backgroundColor: "#fe9701"
    }, {
        title: "Sana Yameen",
        start: new Date(year, month, day + 3, 11, 00),
        end: new Date(year, month, day + 3, 11, 30),
        backgroundColor: "#F3565D"
    }, {
        title: "Kashaf Khan",
        start: new Date(year, month, day + 3, 13, 40),
        end: new Date(year, month, day + 3, 14, 10),
        backgroundColor: "#1bbc9b"
    }, {
        title: "Kashif Umair",
        start: new Date(year, month, day + 3, 15, 30),
        end: new Date(year, month, day + 3, 16, 00),
